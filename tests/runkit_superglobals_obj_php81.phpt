...
if(PHP_VERSION_ID < 80100) print "skip test php 8.1-8.4 due to change to GLOBALS\n";
if(PHP_VERSION_ID >= 80400) print "skip test php 8.1-8.4 due to change to GLOBALS\n";
?>
--INI--
display_errors=on
