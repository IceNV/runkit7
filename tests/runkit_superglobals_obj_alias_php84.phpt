...
if(PHP_VERSION_ID < 80400) print "skip GLOBALS changed in 8.4\n";
?>
--INI--
display_errors=on
...
?>
--EXPECTF--
#0 %srunkit_superglobals_obj_alias_php84.php(41): FooClass->bar()
#1 %srunkit_superglobals_obj_alias_php84.php(44): usefoo()
object(FooClass)#1 (1) {
  ["prop"]=>
  string(5) "value"
}
...
Deprecated: Function runkit_superglobals() is deprecated in %srunkit_superglobals_obj_alias_php84.php on line 6
array(10) packed refcount(1){
  [0]=>
